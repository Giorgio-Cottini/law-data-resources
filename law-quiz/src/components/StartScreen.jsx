...
function NetlifyIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="#32E6E2" aria-hidden="true">
    ...
    <div className="start-screen">
      ...
      <div className="start-card">
        ...
        <a
          ...
          href="https://github.com/Giorgio-Cottini/law-data-resources"
          target="_blank"
          rel="noreferrer"
        >
          Study a bit more
        ...
        <div className="start-footer">
          ...
          <a className="netlify" href="https://www.netlify.com" target="_blank" rel="noreferrer">
